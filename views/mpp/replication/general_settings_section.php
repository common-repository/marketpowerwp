<table class="form-table">
    ...
    <tr valign="top">
        <th width="35%" align="left">
            <label for="default_replicated_site_name">Default replicated site name</label>
        </th>
        <td align="left">
            <input type="text" name="default_replicated_site_name" value="<?php echo $this->replicated_site_name; ?>"/>
            <p class="description">Default replicated site name to use if not specified.</p>
        </td>
    </tr>
    <tr valign="top">
        <th width="35%" align="left">
        ...
        <td align="left">
            ...
            <p class="description">Empty by default and plugin will just send 404 page when a non-existent site
